  ...
  return (
    <main className={styles.main}>
      <div className={styles.content_wrapper}>
        ...
        <P>
          Welcome to HMS Classics, the ultimate destination for classic BMW, VW,
          and Porsche enthusiasts. Our mission is simple yet profound: to
        ...
        <P>
          ...
          James, the heart and soul of HMS Classics. As a child, the allure of a
          classic VW GT4 sparked a lifelong passion, evolving over the years
        ...
        <P>
          Delve into our curated collection of classic BMWs, VWs, and Porsches.
          Whether you&apos;re seeking the elegance of a vintage model or the
          thrill of a limited-edition release, we&apos;re here to guide you
        ...
        <P>
          ...
          fostering connections, and celebrating the timeless beauty of classic
          automobiles.
        </P>
      </div>
    </main>
